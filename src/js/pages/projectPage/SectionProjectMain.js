...
export default class SectionProjectMain {
  ...
  create() {
      ...
      <div class="section-project-main__container">
        <article class="project-information">
          <div class="project-information__main-content">
            <h2 class="project-information__title">${this.title}</h2>
            <p class="project-information__role">${this.role}</p>
            <div class="project-information-skills">
              <h6 class="project-information-skills__title">Использованные технологии</h6>
              <div class="project-information-skills__marquee-wrapper"></div>
            </div>
    ...
    const marquee = new Marquee({ data: this.skillsData, rowsCount: 1, app: this.app });
